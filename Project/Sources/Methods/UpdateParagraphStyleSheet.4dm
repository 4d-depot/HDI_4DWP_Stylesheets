...
If ($styleSheet=Null:C1517)
	...
	$styleSheet:=WP New style sheet:C1650(WParea1;wk type paragraph:K81:191;$stylesheetName)
End if 
...
WP SET ATTRIBUTES:C1342($styleSheet;wk text align:K81:49;_TextAlign_l{_TextAlign})
